        ...
        <div class="min-h-80vh bg-white rounded-md border-0 shadow-md p-5 ">
            <div class="container mt-5">
                ...
                <div class="flex flex-col gap-4 ">
                    ...
                    <label for="created_at" class="font-mono text-sm font-semibold">Date Submitted:
                    {{ \Carbon\Carbon::parse($journal->created_at)->format('M j, Y') }} </label>
                    </div>

                    <div class="flex flex-row gap-[5em]">
                        <div class="form-group">
                            <label for="created_at" class="font-mono text-sm font-semibold">Reflection Coverage:
                            {{ \Carbon\Carbon::parse($journal->coverage_start_date)->format('M j, Y') }} </label>
                        </div>
