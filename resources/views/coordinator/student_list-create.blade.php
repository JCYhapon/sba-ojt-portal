            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form method="post" action="{{ route('coordinator_student-list.store') }}" class="p-4 md:p-5">
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="text-white flex justify-end  bg-yellow-500  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
