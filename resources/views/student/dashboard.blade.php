        ...
        <div class="grid grid-rows-3 lg:gap-12 md:gap-6 gap-4">
            ...
            <div class="lg:row-span-1">
                <div class="bg-white  p-8 shadow-md rounded-md h-40 flex flex-col justify-center items-center gap-6">
                    <div>
                        <h1 class="lg:text-2xl md:text-lg sm:text-lg font-semibold">View Partner Companies Here:</h1>
                    </div>
                    <div><button class="bg-black text-white p-1 rounded-md lg:text-sm lg:w-36 md:text-[14px] md:w-[9rem] sm:text-[14px] sm:w-[9rem]">
