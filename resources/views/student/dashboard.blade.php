...
<body>
    ...
    <div class="w-full lg:container mx-auto lg:max-w-screen-xl  mt-4 lg:p-12 p-4 h-auto">
        ...
        <div class="flex flex-col gap-8 h-auto">
            ...
            <div class=" flex lg:flex-row flex-col justify-between  ">
                <div class="flex flex-col gap-8 bg-white p-6 lg:w-[68%] shadow-md rounded-md" data-aos="fade-right" data-aos-delay="600" data-aos-duration="1000">
                    ...
                    <div class="grid grid-cols-2 ">
                        ...
                        <div class="flex flex-col gap-5">
                            <h2 class="border-b w-[80%]">SBA Social Page</h2>
            ...
            <div class="lg:grid lg:grid-cols-2 md:gap-10 gap-2">
                <div class="bg-white shadow-md rounded-md h-auto flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                    <div>
                ...
                <div class="bg-white shadow-md rounded-md lg:h-48 flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                    <div>
